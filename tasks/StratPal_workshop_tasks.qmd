...
To find the documentation of a function, prepend its name with a question mark and execute it in the console (e.g., `?random_walk`). The help pages are also available on the package webpage (https://mindthegap-erc.github.io/StratPal/) under "Reference".  
...
age-depth models contain a lot of stratigraphic information, e.g. on stratigraphic completeness, hiatuses, or sedimentation rates. Some basic functionality is:
