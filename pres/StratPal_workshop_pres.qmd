...
format: 
  revealjs:
    ...
    incremental: true
    logo: ../figs/logo_tree_horizontal_ERC_square.png
...
![](../figs/PatzkowskyHolland_5-4.png){width="80%"}
...
### Stratigraphic forward modeling {.smaller}

::::: columns
::: {.column width="70%"}
-   Simulate the rock record for a given time and environment type

-   Traditionally used for siliciclastic systems

-   Here we use a carbonate model, CarboKitten.jl, an Open Source model developed in this project
:::

::: {.column width="30%"}
![https://mindthegap-erc.github.io/CarboKitten.jl/](../figs/logo.svg)
:::
:::::
...
+--------------+-------------------------------------------------------------------+
| 9:20-10:05   | Tasks on age-depth models and completeness                        |
|              |                                                                   |
|              | Discuss results together                                          |
+--------------+-------------------------------------------------------------------+
| 10:05-10:20  | Break                                                             |
+--------------+-------------------------------------------------------------------+
| 10:20-10:30  | Trait evolution introduction                                      |
+--------------+-------------------------------------------------------------------+
| 10:30-11:15  | Tasks on trait evolution                                          |
|              |                                                                   |
|              | Discuss results together                                          |
+--------------+-------------------------------------------------------------------+
| 11:15-11:30  | Break                                                             |
+--------------+-------------------------------------------------------------------+
| 11:30-11:40  | Intro occurrence data                                             |
+--------------+-------------------------------------------------------------------+
| 11:40-12:30  | Tasks on event data                                               |
|              |                                                                   |
|              | Discuss results together                                          |
+--------------+-------------------------------------------------------------------+
| 12:30        | **Lunch!** Portland Building Atrium and Richmond Building Atrium, |
+--------------+-------------------------------------------------------------------+

------------------------------------------------------------------------

### Tasks ADMs and incompleteness {.smaller}
...
3.  Run model selection on your simulations in the time and stratigraphic domain.
...
## Event Data and Niche Modeling

::::: columns
::: {.column width="60%"}
![Holland et al. 2024](../figs/occurrence_example.png)
:::
...
::::: columns
::: {.column width="50%"}
![Patzkowsky & Holland (2012)](../figs/PatzkowskyHolland_5-5.png)
:::

::: {.column width="50%"}
-   How does the intersection between ecology and stratigraphy affect fossil abundance?
...
### Tasks on ecology and last occurrences {.smaller}
...
1.  Simulate an abundant taxon and transform the fossil ages into the stratigraphic domain.
    ...
    -   Which stratigraphic effects are these peaks associated with?
...
![Patzkowsky & Holland (2012)](../figs/PatzkowskyHolland_4-10.png)
...
3.  Simulate last occurrences based on the assumption of a constant rate of last occurrences and transform them into the stratigraphic domain.
    ...
    -   What stratigraphic effects are these locations associated with?
...
### Task on range offset and biostratigraphic precision

4.  Explore how biostratigraphic precision (range offset) changes with the true time of extinction, fossil abundance, and position along shore.
...
-   Other effects (taphonomy)

Contributors welcome!\
https://github.com/MindTheGap-ERC/StratPal_workshop_materials
